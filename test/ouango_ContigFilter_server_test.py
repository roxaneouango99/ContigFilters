...
class ouango_ContigFilterTest(unittest.TestCase):
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_ouango_ContigFilter_ok(self):
    ...
    def test_run_ouango_ContigFilter_min_len_negative(self):
    ...
    def test_run_ouango_ContigFilter_min_len_parse(self):
    ...
    def test_run_ouango_ContigFilter_max(self):
            ref = "79/16/1"
            result = self.serviceImpl.run_ouango_ContigFilter_max(self.ctx, {
                'workspace_name': self.wsName,
                'assembly_ref': ref,
                'min_length': 100,
                'max_length': 1000000
    ...
    def test_invalid_params(self):
        ...
        with self.assertRaises(ValueError):
            impl.run_ouango_ContigFilter_max(ctx, {'workspace_name': ws,
                'min_length': 100, 'max_length': 1000000})
        # Missing min length
        with self.assertRaises(ValueError):
            impl.run_ouango_ContigFilter_max(ctx, {'workspace_name': ws, 'assembly_ref': 'x',
                'max_length': 1000000})
        ...
        with self.assertRaises(ValueError):
            impl.run_ouango_ContigFilter_max(ctx, {'workspace_name': ws, 'assembly_ref': 1,
                'min_length': 1, 'max_length': 1000000})
    ...
    def test_run_ouango_ContigFilter_test_min(self):
        ...
        result = self.serviceImpl.run_ouango_ContigFilter_max(self.ctx, params)
